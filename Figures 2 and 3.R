...
model<-readRDS("model_all_combined_10000iters.RData") # this file is too large for the repo - you will need to run R_script_combined_all first to obtain this file.
